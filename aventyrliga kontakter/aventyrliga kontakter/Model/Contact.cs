...
namespace aventyrliga_kontakter.Model
{
    public class Contact
    {
        ...
        [Required(ErrorMessage = "You have to provide an email address."), EmailAddress(ErrorMessage = "You have to provide a valid email address."), StringLength(50, ErrorMessage = "Email Address can not be longer than 50 characters.")]
